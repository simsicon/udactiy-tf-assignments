...
with graph.as_default():
  ...
  hidden_weights = tf.Variable(tf.truncated_normal([num_nodes, num_nodes * 4], -0.1, -0.1))
  ...
  def lstm_cell(i, o, state):
    ...
    prod = tf.matmul(i, input_weights) + tf.matmul(o, hidden_weights) + bias
    prods = tf.split(1, 4, prod)
